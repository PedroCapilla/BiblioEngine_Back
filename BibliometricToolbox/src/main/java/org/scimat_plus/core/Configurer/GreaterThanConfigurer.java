...
import org.scimat_plus.core.Tasks.GreaterThanTask;
...
public class GreaterThanConfigurer implements ConfigureTask<GreaterThanTask> {
    ...
    @Override
    public void setup(GreaterThanTask task, ArgumentStore arguments){
