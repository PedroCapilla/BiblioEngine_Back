...
import org.scimat_plus.core.Tasks.LoaderTask;
...
public class LoaderConfigurer implements ConfigureTask<LoaderTask> {
    ...
    @Override
    public void setup(LoaderTask task, ArgumentStore arguments) {
