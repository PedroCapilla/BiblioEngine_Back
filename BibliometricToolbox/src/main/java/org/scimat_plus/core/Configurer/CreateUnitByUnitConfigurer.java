...
import org.scimat_plus.core.Tasks.CreateUnitByUnitDatasetTask;
...
public class CreateUnitByUnitConfigurer implements ConfigureTask<CreateUnitByUnitDatasetTask>{
    ...
    @Override
    public void setup(CreateUnitByUnitDatasetTask task, ArgumentStore arguments){
